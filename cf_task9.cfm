        ...
        <form name="nform" method="post" action="" class='col-lg-6 offset-lg-3 bg-white p-5'>
            ...
            <div class="row text-success">
                <cfif structKeyExists(form, "Submit")>
                        ...
                        <cfset struct_status=data.structFunc4(key,value)>
                        <cfif struct_status EQ "YES">                            
                                <p class="alert_message pl-5"> <cfoutput> #key# Already exists, Cannot add again.</cfoutput></p>
                        </cfif>                       
                    </cfif>
                </div>
            </form>            
